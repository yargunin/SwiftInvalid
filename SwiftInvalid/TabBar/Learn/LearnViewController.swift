    ...
    override func viewDidLoad() {
        ...
        if self.sections.isEmpty {
            ...
            self.cells = [
                ...
                "Базовые операторы": ["Базовые операторы", "Оператор присваивания", "Арифметические операторы", "Cоставные операторы присваивания", "Операторы сравнения", "Тернарный условный оператор",
                ...
                "Перечесления": ["Перечесления", "Синтаксис перечислений", "Использование перечислений с инструкцией switch", "Итерация по кейсам перечисления", "Ассоциативные значения", "Исходные значения"],
                ...
                "Обработка ошибок": ["Обработка ошибок", "Отображение и генерация ошибок", "Обработка ошибок"],
                ...
                "Автоматический подсчет ссылок (ARC)": ["Автоматический подсчет ссылок (ARC)", "Работа ARC", "ARC в действии", "Циклы сильных ссылок между экземплярами классов", "Замена циклов сильных ссылок между экземплярами классов",
