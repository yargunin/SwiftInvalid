//
//  CompoundOperatorsViewController.swift
//  SwiftInvalid
//
...
class CompoundOperatorsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Cоставные операторы присваивания")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Операторы сравнения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ComparisonOperatorsViewController") as! ComparisonOperatorsViewController
