//
//  TheUnionOperatorViewController.swift
//  SwiftInvalid
//
...
class TheUnionOperatorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Оператор объединения по nil")
        let resizedImage = originalImage?.resize(toWidth: 365, height: 1200)
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Операторы диапазона", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "RangeOperatorViewController") as! RangeOperatorViewController
