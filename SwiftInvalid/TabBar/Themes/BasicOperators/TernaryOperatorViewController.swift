//
//  TernaryOperatorViewController.swift
//  SwiftInvalid
//
...
class TernaryOperatorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Тернарный условный оператор")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Оператор объединения по nil", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TheUnionOperatorViewController") as! TheUnionOperatorViewController
