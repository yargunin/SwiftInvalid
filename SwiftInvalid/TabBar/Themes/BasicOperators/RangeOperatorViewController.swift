...
class RangeOperatorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Операторы диапазона")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Логические операторы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "LogicalOperatorsViewController") as! LogicalOperatorsViewController
