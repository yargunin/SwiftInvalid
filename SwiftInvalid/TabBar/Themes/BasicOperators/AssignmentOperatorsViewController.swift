//
//  AssignmentOperatorsViewController.swift
//  SwiftInvalid
//
...
class AssignmentOperatorsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Оператор присваивания")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Арифметические операторы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ArithmeticOperatorsViewController") as! ArithmeticOperatorsViewController
