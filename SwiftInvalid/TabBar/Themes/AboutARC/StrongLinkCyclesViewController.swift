//
//  StrongLinkCyclesViewController.swift
//  SwiftInvalid
//
...
class StrongLinkCyclesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Циклы сильных ссылок между экземплярами классов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Замена циклов сильных ссылок\n между экземплярами классов", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ReplacingCyclesViewController") as! ReplacingCyclesViewController
