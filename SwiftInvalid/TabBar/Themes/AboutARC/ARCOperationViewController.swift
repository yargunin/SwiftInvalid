//
//  ARCOperationViewController.swift
//  SwiftInvalid
//
...
class ARCOperationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("ARC в действии", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ARCInActionViewController") as! ARCInActionViewController
