...
class AboutARCViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Автоматический подсчет ссылок (ARC)")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Работа ARC", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ARCOperationViewController") as! ARCOperationViewController
