//
//  CyclesClosuresViewController.swift
//  SwiftInvalid
//
...
class CyclesClosuresViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Циклы сильных ссылок в замыканиях")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Замена циклов сильных\n ссылок в замыканиях", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ReplacementInClosuresViewController") as! ReplacementInClosuresViewController
