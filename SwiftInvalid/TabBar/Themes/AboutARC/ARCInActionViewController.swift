//
//  ARCInActionViewController.swift
//  SwiftInvalid
//
...
class ARCInActionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "ARC в действии")
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StrongLinkCyclesViewController") as! StrongLinkCyclesViewController
