//
//  ReplacementInClosuresViewController.swift
//  SwiftInvalid
//
...
class ReplacementInClosuresViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Замена циклов сильных ссылок в замыканиях")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Безопасность хранения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StorageSecurityViewController") as! StorageSecurityViewController
