...
class ConsistencyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Согласованность")
        let resizedImage = originalImage?.resize(toWidth: 365, height: 1600)
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Определение и вызов\n асинхронных функций", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "DefinitionChallengeViewController") as! DefinitionChallengeViewController
