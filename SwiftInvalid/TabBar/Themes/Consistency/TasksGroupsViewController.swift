//
//  TasksGroupsViewController.swift
//  SwiftInvalid
//
...
class TasksGroupsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Задачи и группы задач")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Приведение типов", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypeConversionViewController") as! TypeConversionViewController
