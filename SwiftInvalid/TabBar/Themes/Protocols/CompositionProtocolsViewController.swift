//
//  CompositionProtocolsViewController.swift
//  SwiftInvalid
//
...
class CompositionProtocolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Композиция протоколов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Проверка соответствия протоколу", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CheckingProtocolsViewController") as! CheckingProtocolsViewController
