//
//  CollectionsProtocolTypesViewController.swift
//  SwiftInvalid
//
...
class CollectionsProtocolTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CompositionProtocolsViewController") as! CompositionProtocolsViewController
