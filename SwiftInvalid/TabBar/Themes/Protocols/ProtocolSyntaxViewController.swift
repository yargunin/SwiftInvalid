//
//  ProtocolSyntaxViewController.swift
//  SwiftInvalid
//
...
class ProtocolSyntaxViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Синтаксис протокола")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Требование свойств", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "PropertyRequirementViewController") as! PropertyRequirementViewController
