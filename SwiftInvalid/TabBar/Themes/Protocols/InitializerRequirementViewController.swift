//
//  InitializerRequirementViewController.swift
//  SwiftInvalid
//
...
class InitializerRequirementViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Требование инициализатора")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Протоколы как типы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ProtocolsAsTypesViewController") as! ProtocolsAsTypesViewController
