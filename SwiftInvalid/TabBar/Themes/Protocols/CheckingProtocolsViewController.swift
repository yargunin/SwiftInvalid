//
//  CheckingProtocolsViewController.swift
//  SwiftInvalid
//
...
class CheckingProtocolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Проверка соответствия протоколу")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Опциональные требования протокола", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "OptionalRequirementsViewController") as! OptionalRequirementsViewController
