//
//  RequirementsModifyingMethodsViewController.swift
//  SwiftInvalid
//
...
class RequirementsModifyingMethodsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Требования изменяющих методов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Требование инициализатора", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InitializerRequirementViewController") as! InitializerRequirementViewController
