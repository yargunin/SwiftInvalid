//
//  PropertyRequirementViewController.swift
//  SwiftInvalid
//
...
class PropertyRequirementViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Требование свойств")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Требование методов", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "MethodsRequirementViewController") as! MethodsRequirementViewController
