...
class ProtocolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Протоколы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Синтаксис протокола", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ProtocolSyntaxViewController") as! ProtocolSyntaxViewController
