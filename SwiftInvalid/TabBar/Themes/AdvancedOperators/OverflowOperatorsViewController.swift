//
//  OverflowOperatorsViewController.swift
//  SwiftInvalid
//
...
class OverflowOperatorsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Операторы переполнения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Приоритет и ассоциативность", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "PriorityAssociativityViewController") as! PriorityAssociativityViewController
