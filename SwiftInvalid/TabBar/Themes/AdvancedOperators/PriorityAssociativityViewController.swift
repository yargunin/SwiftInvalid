//
//  PriorityAssociativityViewController.swift
//  SwiftInvalid
//
...
class PriorityAssociativityViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Приоритет и ассоциативность")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Операторные функции", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "OperatorFunctionsViewController") as! OperatorFunctionsViewController
