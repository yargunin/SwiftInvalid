...
class AdvancedOperatorsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Продвинутые операторы")
        let resizedImage = originalImage?.resize(toWidth: 365, height: 600)
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Побитовые операторы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "BitwiseOperatorsViewController") as! BitwiseOperatorsViewController
