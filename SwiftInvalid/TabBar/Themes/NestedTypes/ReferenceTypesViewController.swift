//
//  ReferenceTypesViewController.swift
//  SwiftInvalid
//
...
class ReferenceTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Расширения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ExtensionsViewController") as! ExtensionsViewController
