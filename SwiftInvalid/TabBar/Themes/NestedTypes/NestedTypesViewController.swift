...
class NestedTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Вложенные типы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Вложенные типы в действии", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypesActionViewController") as! TypesActionViewController
