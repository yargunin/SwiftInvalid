//
//  TypesActionViewController.swift
//  SwiftInvalid
//
...
class TypesActionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Вложенные типы в действии")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Ссылка на вложенные типы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ReferenceTypesViewController") as! ReferenceTypesViewController
