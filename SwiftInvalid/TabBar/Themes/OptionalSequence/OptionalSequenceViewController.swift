//
//  OptionalSequenceViewController.swift
//  SwiftInvalid
//
...
class OptionalSequenceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Опциональная последовательность")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Обработка ошибок", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ErrorHandlingViewController") as! ErrorHandlingViewController
