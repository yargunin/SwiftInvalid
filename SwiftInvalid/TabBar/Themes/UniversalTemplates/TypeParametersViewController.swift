//
//  TypeParametersViewController.swift
//  SwiftInvalid
//
...
class TypeParametersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Параметры типа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Расширяем универсальный тип", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ExpandingUniversalTypeViewController") as! ExpandingUniversalTypeViewController
