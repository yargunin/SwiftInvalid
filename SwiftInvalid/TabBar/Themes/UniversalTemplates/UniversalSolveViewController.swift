//
//  UniversalSolveViewController.swift
//  SwiftInvalid
//
...
class UniversalSolveViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Проблема, которую решают универсальные шаблоны")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Универсальные функции", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "UniversalFunctionsViewController") as! UniversalFunctionsViewController
