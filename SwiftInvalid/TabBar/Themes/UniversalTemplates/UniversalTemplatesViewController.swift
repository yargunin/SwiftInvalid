//
//  UniversalTemplatesViewController.swift
//  SwiftInvalid
//
...
class UniversalTemplatesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Универсальные шаблоны")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Проблема, которую решают\n универсальные шаблоны", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "UniversalSolveViewController") as! UniversalSolveViewController
