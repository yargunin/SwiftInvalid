//
//  UniversalFunctionsViewController.swift
//  SwiftInvalid
//
...
class UniversalFunctionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Универсальные функции")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Параметры типа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypeParametersViewController") as! TypeParametersViewController
