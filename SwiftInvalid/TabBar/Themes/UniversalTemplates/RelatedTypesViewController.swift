//
//  RelatedTypesViewController.swift
//  SwiftInvalid
//
...
class RelatedTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Связанные типы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Оговорка where", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ReservationWhereViewController") as! ReservationWhereViewController
