//
//  ExpandingUniversalTypeViewController.swift
//  SwiftInvalid
//
...
class ExpandingUniversalTypeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Расширяем универсальный тип")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Связанные типы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "RelatedTypesViewController") as! RelatedTypesViewController
