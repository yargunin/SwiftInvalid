//
//  ReservationWhereViewController.swift
//  SwiftInvalid
//
...
class ReservationWhereViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Оговорка where")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("О ARC", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AboutARCViewController") as! AboutARCViewController
