//
//  FunctionalTypesViewController.swift
//  SwiftInvalid
//
...
class FunctionalTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Функциональные типы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Вложенные функции", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "NestedFunctionsViewController") as! NestedFunctionsViewController
