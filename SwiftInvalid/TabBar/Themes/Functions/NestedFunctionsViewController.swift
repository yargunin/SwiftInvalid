//
//  NestedFunctionsViewController.swift
//  SwiftInvalid
//
...
class NestedFunctionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Вложенные функции")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Замыкания", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ClosuresViewController") as! ClosuresViewController
