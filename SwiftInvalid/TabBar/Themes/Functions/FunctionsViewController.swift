...
class FunctionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Функции")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Объявление и вызов функций", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AnnouncementAndChallengeViewController") as! AnnouncementAndChallengeViewController
