//
//  StringAlignmentViewController.swift
//  SwiftInvalid
//
...
class StringAlignmentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Сравнение строк")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Типы коллекций", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AboutTypesViewController") as! AboutTypesViewController
