...
class InterpolationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Интерполяция строк")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Юникод (Unicode)", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "UnicodeViewController") as! UnicodeViewController
