//
//  InitializerEmptyStringsViewController.swift
//  SwiftInvalid
//
...
class InitializerEmptyStringsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Инициализация пустых строк")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Конкатенация строк и символов", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ConcatenationViewController") as! ConcatenationViewController
