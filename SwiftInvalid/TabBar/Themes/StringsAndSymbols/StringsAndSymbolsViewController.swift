//
//  StringsAndSymbolsViewController.swift
//  SwiftInvalid
//
...
class StringsAndSymbolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Строки и символы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Строковые литералы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StringLiteralsViewController") as! StringLiteralsViewController
