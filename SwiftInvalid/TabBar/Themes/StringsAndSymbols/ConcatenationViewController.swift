//
//  ConcatenationViewController.swift
//  SwiftInvalid
//
...
class ConcatenationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Конкатенация строк и символов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Интерполяция строк", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InterpolationViewController") as! InterpolationViewController
