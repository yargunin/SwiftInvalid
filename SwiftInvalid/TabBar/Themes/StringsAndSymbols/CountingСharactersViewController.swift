//
//  CountingСharactersViewController.swift
//  SwiftInvalid
//
...
class CountingCharactersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Подсчет символов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Доступ и изменение строки", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ModificationViewController") as! ModificationViewController
