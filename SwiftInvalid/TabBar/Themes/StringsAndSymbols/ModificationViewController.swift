...
class ModificationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Доступ и изменение строки")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Подстроки", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SubstringsViewController") as! SubstringsViewController
