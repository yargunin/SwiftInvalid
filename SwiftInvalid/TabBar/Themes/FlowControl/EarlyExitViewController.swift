...
class EarlyExitViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Ранний выход и Проверка доступности API")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Функции", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "FunctionsViewController") as! FunctionsViewController
