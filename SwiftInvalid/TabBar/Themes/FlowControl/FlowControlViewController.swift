...
class FlowControlViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Управление потоком")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Циклы For-in", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CyclesForInViewController") as! CyclesForInViewController
