//
//  CyclesForInViewController.swift
//  SwiftInvalid
//
...
class CyclesForInViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Циклы For-in")
        let resizedImage = originalImage?.resize(toWidth: 365, height: 2200)
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Циклы While", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CyclesWhileViewController") as! CyclesWhileViewController
