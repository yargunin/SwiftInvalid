//
//  AccessLevelsViewController.swift
//  SwiftInvalid
//
...
class AccessLevelsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Уровни доступа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Синтаксис контроля доступа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ControlSyntaxViewController") as! ControlSyntaxViewController
