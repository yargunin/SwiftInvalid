//
//  ModulesFilesViewController.swift
//  SwiftInvalid
//
...
class ModulesFilesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Модули и исходные файлы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Уровни доступа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AccessLevelsViewController") as! AccessLevelsViewController
