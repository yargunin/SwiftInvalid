...
class AccessControlViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Контроль доступа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Модули и исходные файлы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ModulesFilesViewController") as! ModulesFilesViewController
