//
//  SubclassInheritanceViewController.swift
//  SwiftInvalid
//
...
class SubclassInheritanceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Наследование подклассом")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Переопределение", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "RedefinitionViewController") as! RedefinitionViewController
