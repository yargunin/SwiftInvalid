...
class InheritanceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Наследование")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Определение базового класса", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "DefiningBaseClassViewController") as! DefiningBaseClassViewController
