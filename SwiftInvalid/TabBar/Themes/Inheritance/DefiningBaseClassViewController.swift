//
//  DefiningBaseClassViewController.swift
//  SwiftInvalid
//
...
class DefiningBaseClassViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Определение базового класса")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Наследование подклассом", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SubclassInheritanceViewController") as! SubclassInheritanceViewController
