//
//  PreventingOverridesViewController.swift
//  SwiftInvalid
//
...
class PreventingOverridesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Инициализация", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InitializationViewController") as! InitializationViewController
