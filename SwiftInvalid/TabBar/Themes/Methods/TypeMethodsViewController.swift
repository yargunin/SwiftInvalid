//
//  TypeMethodsViewController.swift
//  SwiftInvalid
//
...
class TypeMethodsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Методы типа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Сабскрипты", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SubscriptsViewController") as! SubscriptsViewController
