//
//  InstanceMethodsViewController.swift
//  SwiftInvalid
//
...
class InstanceMethodsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Методы экземпляра")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Методы типа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypeMethodsViewController") as! TypeMethodsViewController
