...
class MethodsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Методы экземпляра", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InstanceMethodsViewController") as! InstanceMethodsViewController
