...
class TransfersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Перечисления")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Синтаксис перечислений", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "EnumerationSyntaxViewController") as! EnumerationSyntaxViewController
