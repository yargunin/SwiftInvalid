//
//  UsingEnumerationsViewController.swift
//  SwiftInvalid
//
...
class UsingEnumerationsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Использование перечислений с инструкцией switch")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Итерация по кейсам перечисления", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CaseByCaseViewController") as! CaseByCaseViewController
