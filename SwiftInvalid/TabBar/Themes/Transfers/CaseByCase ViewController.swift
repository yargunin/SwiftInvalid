//
//  CaseByCase ViewController.swift
//  SwiftInvalid
//
...
class CaseByCaseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Итерация по кейсам перечисления")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Ассоциативные значения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AssociativeValuesViewController") as! AssociativeValuesViewController
