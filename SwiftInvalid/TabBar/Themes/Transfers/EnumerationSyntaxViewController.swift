//
//  EnumerationSyntaxViewController.swift
//  SwiftInvalid
//
...
class EnumerationSyntaxViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Синтаксис перечислений")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Использование перечислений\n с инструкцией switch", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "UsingEnumerationsViewController") as! UsingEnumerationsViewController
