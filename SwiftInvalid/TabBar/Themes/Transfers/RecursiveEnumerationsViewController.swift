//
//  RecursiveEnumerationsViewController.swift
//  SwiftInvalid
//
...
class RecursiveEnumerationsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Рекурсивные перечисления")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Структуры и классы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StructuresAndClassesViewController") as! StructuresAndClassesViewController
