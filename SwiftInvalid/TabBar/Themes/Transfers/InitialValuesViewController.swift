//
//  InitialValuesViewController.swift
//  SwiftInvalid
//
...
class InitialValuesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Исходные значения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Рекурсивные перечисления", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "RecursiveEnumerationsViewController") as! RecursiveEnumerationsViewController
