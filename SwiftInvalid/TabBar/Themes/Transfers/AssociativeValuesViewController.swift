//
//  AssociativeValuesViewController.swift
//  SwiftInvalid
//
...
class AssociativeValuesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Ассоциативные значения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Исходные значения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InitialValuesViewController") as! InitialValuesViewController
