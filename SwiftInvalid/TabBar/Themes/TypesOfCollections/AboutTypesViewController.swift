...
class AboutTypesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Типы коллекций")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Массивы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ArrayViewController") as! ArrayViewController
