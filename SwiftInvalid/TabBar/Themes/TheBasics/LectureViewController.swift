...
class LectureViewController: UIViewController {
    ...
    @IBOutlet var varAndLet: UILabel!
    ...
    override func viewDidLoad() {
        ...
        """
        varAndLet.lineBreakMode = .byWordWrapping
        varAndLet.font = UIFont.systemFont(ofSize: 17)
        varAndLet.numberOfLines = 0
        varAndLet.sizeToFit()
        
        // Добавление UILabel в UIScrollView
        scrollView.addSubview(varAndLet)
        ...
        button.setTitle("Типы данных", for: .normal)
