...
class LetAndVarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Название констант и переменных")
        let resizedImage = originalImage?.resize(toWidth: 370, height: 1300)
        ...
        button.setTitle("Комментарии", for: .normal)
    ...
    @objc func buttonTapped() {
        let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "CommentsViewController") as! CommentsViewController
