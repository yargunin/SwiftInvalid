...
class InitializationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Инициализация")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Установка начальных значений\n для свойств хранения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SettingValuesViewController") as! SettingValuesViewController
