//
//  DelegatingInitializerViewController.swift
//  SwiftInvalid
//
...
class DelegatingInitializerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Делегирование инициализатора для типов значения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Наследование и\n инициализация класса", for: .normal)
            ...
            button.frame = CGRect(x: scrollView.contentSize.width - 210, y: scrollView.contentSize.height, width: 200, height: -100)
            scrollView.addSubview(button)
        }
        
        // действие при нажатии на кнопку
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "InitializerInheritanceViewController") as! InitializerInheritanceViewController
