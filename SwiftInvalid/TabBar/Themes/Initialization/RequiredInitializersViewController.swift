//
//  RequiredInitializersViewController.swift
//  SwiftInvalid
//
...
class RequiredInitializersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Деинициализация", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "DeinitializationViewController") as! DeinitializationViewController
