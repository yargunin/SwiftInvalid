//
//  SettingValuesViewController.swift
//  SwiftInvalid
//
...
class SettingValuesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Установка начальных значений для свойств хранения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Настройка инициализации", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SettingInitializationViewController") as! SettingInitializationViewController
