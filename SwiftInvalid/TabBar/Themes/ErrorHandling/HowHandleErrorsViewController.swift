//
//  HowHandleErrorsViewController.swift
//  SwiftInvalid
//
...
class HowHandleErrorsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Как обрабатывать ошибки")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Согласованность", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ConsistencyViewController") as! ConsistencyViewController
