//
//  TypeDifferencesViewController.swift
//  SwiftInvalid
//
...
class TypeDifferencesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Различия между типом протокола и непрозрачным типом")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Протоколы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ProtocolsViewController") as! ProtocolsViewController
