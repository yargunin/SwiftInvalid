//
//  TypeReturnViewController.swift
//  SwiftInvalid
//
...
class TypeReturnViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Возвращение непрозрачного типа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Различия между типом протокола\n и непрозрачным типом", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypeDifferencesViewController") as! TypeDifferencesViewController
