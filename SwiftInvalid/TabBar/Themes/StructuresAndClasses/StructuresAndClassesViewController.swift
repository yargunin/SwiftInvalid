...
class StructuresAndClassesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Структуры и классы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Сравнение классов и структур", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ClassComparisonViewController") as! ClassComparisonViewController
