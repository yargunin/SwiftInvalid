//
//  StructuresAndEnumerationsViewController.swift
//  SwiftInvalid
//
...
class StructuresAndEnumerationsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Структуры и перечисления - типы значения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Классы - ссылочный тип", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ReferenceClassesViewController") as! ReferenceClassesViewController
