//
//  ClassComparisonViewController.swift
//  SwiftInvalid
//
...
class ClassComparisonViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Сравнение классов и структур")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Структуры и перечисления -\n типы значения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StructuresAndEnumerationsViewController") as! StructuresAndEnumerationsViewController
