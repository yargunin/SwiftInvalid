//
//  SubscriptSyntaxViewController.swift
//  SwiftInvalid
//
...
class SubscriptSyntaxViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Синтаксис сабскрипта")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Использование сабскрипта", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "UsingSubscriptViewController") as! UsingSubscriptViewController
