//
//  UsingSubscriptViewController.swift
//  SwiftInvalid
//
...
class UsingSubscriptViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Использование сабскрипта")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Опции сабскрипта", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SubscriptOptionsViewController") as! SubscriptOptionsViewController
