...
class SubscriptsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Сабскрипты")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Синтаксис сабскрипта", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SubscriptSyntaxViewController") as! SubscriptSyntaxViewController
