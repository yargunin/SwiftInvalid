//
//  ReferentialClosuresViewController.swift
//  SwiftInvalid
//
...
class ReferentialClosuresViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Замыкания - ссылочный тип")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Перечисления", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TransfersViewController") as! TransfersViewController
