...
class TypeCheckViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            ...
            button.setTitle("Понижающее приведение", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StepDownCastViewController") as! StepDownCastViewController
