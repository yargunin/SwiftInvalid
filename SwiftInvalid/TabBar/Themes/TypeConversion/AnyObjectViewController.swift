...
class AnyObjectViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Методы")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Вложенные типы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "NestedTypesViewController") as! NestedTypesViewController
