//
//  DefiningHierarchyViewController.swift
//  SwiftInvalid
//
...
class DefiningHierarchyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Определение классовой иерархии для приведения типов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Проверка типа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypeCheckViewController") as! TypeCheckViewController
