//
//  TypeConversionViewController.swift
//  SwiftInvalid
//
...
class TypeConversionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Приведение типов")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Определение классовой иерархии\n для приведения типов", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "DefiningHierarchyViewController") as! DefiningHierarchyViewController
