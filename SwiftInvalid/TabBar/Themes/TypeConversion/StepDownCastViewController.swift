//
//  StepDownCastViewController.swift
//  SwiftInvalid
//
...
class StepDownCastViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Понижающее приведение")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Приведение типов для Any и AnyObject", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AnyObjectViewController") as! AnyObjectViewController
