//
//  ExtensionMethodsViewController.swift
//  SwiftInvalid
//
...
class ExtensionMethodsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Непрозрачные типы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "OpaqueTypesViewController") as! OpaqueTypesViewController
