...
class ExtensionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "SyntaxExtensionsViewController") as! SyntaxExtensionsViewController
