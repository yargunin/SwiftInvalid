//
//  SyntaxExtensionsViewController.swift
//  SwiftInvalid
//
...
class SyntaxExtensionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Синтаксис расширений")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Вычисляемые свойства\n в расширениях", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "PropertiesExtensionsViewController") as! PropertiesExtensionsViewController
