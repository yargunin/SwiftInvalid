//
//  ExtensionInitializersViewController.swift
//  SwiftInvalid
//
...
class ExtensionInitializersViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Инициализаторы в расширениях")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Методы в расширениях", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ExtensionMethodsViewController") as! ExtensionMethodsViewController
