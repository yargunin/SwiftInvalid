//
//  TypePropertiesViewController.swift
//  SwiftInvalid
//
...
class TypePropertiesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Свойства типа")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Методы", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "MethodsViewController") as! MethodsViewController
