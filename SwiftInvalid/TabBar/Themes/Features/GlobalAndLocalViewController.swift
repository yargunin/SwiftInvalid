//
//  GlobalAndLocalViewController.swift
//  SwiftInvalid
//
...
class GlobalAndLocalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Глобальные и локальные переменные")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Свойства типа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "TypePropertiesViewController") as! TypePropertiesViewController
