...
class FeaturesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Свойства")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Свойства хранения", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "StoragePropertiesViewController") as! StoragePropertiesViewController
