//
//  WrappersForPropertiesViewController.swift
//  SwiftInvalid
//
...
class WrappersForPropertiesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Обертки для свойств")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Глобальные и локальные переменные", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "GlobalAndLocalViewController") as! GlobalAndLocalViewController
