...
class PropertyObserversViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Наблюдатели свойства")
        let resizedImage = originalImage?.resize(toWidth: 365, height: 2700)
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Обертки для свойств", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "WrappersForPropertiesViewController") as! WrappersForPropertiesViewController
