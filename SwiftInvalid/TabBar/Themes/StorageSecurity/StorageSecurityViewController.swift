//
//  StorageSecurityViewController.swift
//  SwiftInvalid
//
...
class StorageSecurityViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Безопасность хранения")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Что такое конфликт\n доступа к памяти", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AccessConflictViewController") as! AccessConflictViewController
