...
class AccessCharacteristicsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Характеристики доступа к памяти")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Конфликты", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "ConflictsViewController") as! ConflictsViewController
