//
//  AccessConflictViewController.swift
//  SwiftInvalid
//
...
class AccessConflictViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Что такое конфликт доступа к памяти")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Характеристики доступа к памяти", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AccessCharacteristicsViewController") as! AccessCharacteristicsViewController
