...
class ConflictsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let originalImage = UIImage(named: "Конфликт доступа к сквозным параметрам")
        ...
        LableInfo.attributedText = imageString
            ...
            button.setTitle("Контроль доступа", for: .normal)
        ...
        @objc func buttonTapped() {
            let NextVC = UIStoryboard(name: "TabBar", bundle: nil).instantiateViewController(withIdentifier: "AccessControlViewController") as! AccessControlViewController
